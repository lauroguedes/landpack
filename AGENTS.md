...
When asked to adapt or personalize this template for a project, read
[landpack-customize](.agents/skills/landpack-customize/SKILL.md). Its project map
covers content, branding, shared labels, assets, and SEO while preserving the
template structure. The canonical skill lives in `.agents/skills/`; a
`.claude/skills/landpack-customize` alias supports Claude Code discovery.
